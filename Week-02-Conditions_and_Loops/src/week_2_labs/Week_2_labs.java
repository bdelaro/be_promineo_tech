...
public class Week_2_labs {
	public static void main(String[] args) {
		...
		// change the value of age and re-run to see the result
		if (age >= 16) {
		...
		// using a switch, set the value of loyaltyMemberDiscount based on the following
		// loyaltyMemberStatus scale
		...
		case "PLATINUM":
			...
			break;
		default:
			System.out.println("Please input valid loyalty member status.");
		}
		...
		// if the adjustedBillTotal is greater than $500 upgrade the loyaltyMemberStatus
		// from SILVER to GOLD or GOLD to PLATINUM
		...
		// write a while loop that starts at 100 and iterates backwards by 1 until it
		// reaches 0
